...
const FooterLink: React.FC<FooterLinkProps> = ({ href, children }) => (
  <Link href={href} className="text-gray-600 hover:text-gray-800 text-sm transition-colors">
    {children}
  </Link>
);
...
const Footer: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 items-start">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <h2 className="text-3xl font-bold text-gray-900">Jadoo <span className="w-2 h-2 bg-black rounded-full"></span></h2>
  ...
  {/* Facebook - white circle with icon */}
  ...
  {/* Instagram - gradient circle with icon */}
  <Link href="#" className="group">
  ...
  {/* Twitter - white circle with icon */}
  <Link href="#" className="group">
    <div className="bg-white shadow-md rounded-full p-2 transition-transform transform group-hover:scale-105">
  ...
  <Link href="#">
    <div className="bg-black text-white px-3 py-2 rounded-4xl text-sm hover:bg-gray-800 flex items-center gap-2">
      <Image src="/playstore.png" alt="Google Play" width={20} height={20} />
      Google Play
    </div>
  </Link>
