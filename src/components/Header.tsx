   ...
   return(
    <header className="w-full   fixed top-2 left-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:8">
         ...
         <div className="text-3xl font-bold text-black flex items-center ml-6">
        <span>Jad</span>
        <div className="flex items-center ">
          <div className="w-4 h-5 bg-[#F1A501] rounded-full border-3"></div>
          <div className="w-4 h-5 bg-[#F1A501] rounded-full  border-3 "></div>
        </div>
      </div>

          {/* Navigation */}
          <nav className="hidden md:flex space-x-6 items-center text-[#212832] font-medium gap-6">
            <a href="#" className="">Destinations</a>
            <a href="#" className="">Hotels</a>
            <a href="#" className="">Flights</a>
            <a href="#" className="">Bookings</a>
          ...
          {/* Optional: Mobile menu toggle for future use */}
          <div className="md:hidden">
            {/* Hamburger icon goes here if needed */}
          </div>
        </div>
        </div>
